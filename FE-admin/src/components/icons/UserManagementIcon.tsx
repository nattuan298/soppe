...
export default function UserManagementIcon(props: SvgIconConstituentValues) {
  return (
    <svg
      id="user_management_black_24dp"
      ...
      {...props}
    >
      <path id="Path_3746" data-name="Path 3746" d="M0,0H24V24H0Z" fill="none" />
      <path
        id="Path_3747"
        data-name="Path 3747"

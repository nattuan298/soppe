...
class AdminSignUpDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { username: { required: true, type: () => String, minLength: 6 }, password: { required: true, type: () => String, minLength: 8 }, email: { required: true, type: () => String }, phoneNumber: { required: true, type: () => String }, avatar: { required: true, type: () => String } };
    }
}
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], AdminSignUpDto.prototype, "avatar", void 0);
exports.AdminSignUpDto = AdminSignUpDto;
//# sourceMappingURL=admin-sign-up.dto.js.map
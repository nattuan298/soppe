...
export const TableNearExpireMemberList = ({ list, index, screen }: TableNoCollapsibleProps) => {
  ...
  return (
    <div style={{ height: isOpen ? "auto" : 70, border: isOpen ? "1px solid #FF7500" : "none" }}>
      ...
      >
        ...
        <div className="text-sm font-medium w-[30%] md:w-[23%]">
          <p style={{ marginTop: "24px" }}>{list.expireDate}</p>
        </div>
        <div className="text-sm font-medium pl-4" style={{ width: "15%", marginTop: "24px" }}>
        ...
        {screen! === "Mobile" && (
          <div className="flex flex-row-reverse items-center pl-8" style={{ width: "6%" }}>
            <div

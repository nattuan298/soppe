    ...
    <Portal preventScroll>
      <div
        ...
        className={classnames(
          ...
          containerClasses,
          !containerClassName?.includes("bg-opacity-") && "bg-opacity-70",
          containerClassName,
...
function makeContainerClass(duration: number) {
  return `fixed flex w-full inset-0 z-[10000] sm:z-30 overflow-y-auto bg-mask transition-opacity duration-${duration} ease-in-out`;
}
